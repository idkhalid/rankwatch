<x-guest-layout>
    <x-slot:title>Choose new password - RankWatch</x-slot:title>
    <x-slot:heading>Choose a new password</x-slot:heading>
    <x-slot:subheading>Use a strong password to keep your monitoring workspace protected.</x-slot:subheading>
